...
var isConstructor = __webpack_require__(9);
var isObject = __webpack_require__(111);
var wellKnownSymbol = __webpack_require__(5112);
...
var $ = __webpack_require__(2109);
var createHTML = __webpack_require__(4879);
...
var hasOwn = __webpack_require__(2597);
var wellKnownSymbol = __webpack_require__(5112);
var IteratorPrototype = (__webpack_require__(4307).IteratorPrototype);
var IS_PURE = __webpack_require__(1913);
...
;// CONCATENATED MODULE: ./src/db/links.json
var links_namespaceObject = JSON.parse('[{"id":"1","name":"github","link":"https://github.com/KostyanB"},{"id":"2","name":"email","link":"mailto:berezkok72@gmail.com"},{"id":"3","name":"telegram","link":"https://t.me/berezkok"},{"id":"4","name":"skype","link":"https://join.skype.com/invite/czlhC4HdrM5C"},{"id":"5","name":"whatsapp","link":"https://wa.me/79090900002"}]');
;// CONCATENATED MODULE: ./src/modules/drawLinks.js
...
var drawLinks = function drawLinks() {
  ...
  headerLinks.innerHTML = links_namespaceObject.reduce(function (acc, item) {
    var name = item.name,
        link = item.link;
    return acc + "\n        <a href=\"".concat(link, "\" class=\"header__links_soc\">\n          <svg class=\"").concat(name, "\">\n            <use xlink:href=\"img/icons.svg#").concat(name, "\" />\n          </svg>\n        </a>\n      ");
  }, '');
};
...
var works_namespaceObject = JSON.parse('[{"demoUrl":"https://iphone-promo.web.app/","description":"\\"Promo iPhone13\\". Single Page Application. Полностью реализована промо-страница. Выбор модели, просмотр характеристик, добавление Cross-sell товаров, отправка заказа.","gitUrl":"https://github.com/KostyanB/promo-iphone13","id":"1","imgSrc":"img/iphone.webp","name":"Promo iPhone13","stack":"React JS, SPA, Styled Components, React-Spring animation, React Router, Suspense loading, RestAPI"},{"demoUrl":"https://cinema-booker-51e5e.web.app/","description":"\\"Cinema-booker\\". Сайт кинотеатра. Реализован блок выбора сеанса и бронирования билетов. Сохранение брони в течение сессии. Синхронизация с сервером. Просмотр трейлера.","gitUrl":"https://github.com/KostyanB/cinema","id":"2","imgSrc":"img/cinema.webp","name":"Cinema-booker","stack":"React, SPA, Styled Components, Router, Hooks,  RestAPI"},{"demoUrl":"https://lomoda-spa.firebaseapp.com/","description":"Pet-проект \\"Lomoda\\". Приложение по дизайн-макету известного интернет-магазина. Загрузка товаров restAPI, формирование корзины и отправка заказа. Настройки приложения в json файле. Хранение локации и корзины в LocalStorage браузера.","gitUrl":"https://github.com/KostyanB/Lomoda-SPA","id":"3","imgSrc":"img/lomoda.webp","name":"Lomoda","stack":"React JS, Redux/Toolkit, Styled Components, Router, Hooks, SCSS, SPA"},{"demoUrl":"https://melody-home-32b02.web.app/","description":"Cайт продаж квартир ЖК \\"Мелодия\\". Реализованы главная страница и модальное окно плана этажа. Интерактивный выбор этажа квартиры на этаже. Динамическое SVG.","gitUrl":"https://github.com/KostyanB/Melody-Home","id":"4","imgSrc":"img/home.webp","name":"Melody-Home","stack":"React JS, Styled Components, React Hooks, SVG"},{"demoUrl":"https://sorting-tab.web.app/","description":"\\"Sorting tab\\". DragScroll. Поддержка темной темы. Загрузка данных по АПИ. Вывод суммарного времени посещений по дням и за месяц. Сортировка по столбцам. Фильтрация по имени / части имени и ID. Пагинация. Модальный вывод курса валют при клике на дату в шапке.","gitUrl":"https://github.com/KostyanB/sorting-tab","id":"5","imgSrc":"img/sorting.webp","name":"Sorting tab","stack":"React JS, Recoil, Styled Components, React Animation, Drag Scroll, RestAPI, Dark theme"},{"demoUrl":"https://divi-test-task.web.app/","description":"Диаграмма времени посещений за неделю с разбивкой по возрасту пользователя и фильтрацией по ID девайса. Получение данных по api. Анимация перестроения диаграммы. Построение и анимация без использования сторонних библиотек.","gitUrl":"https://github.com/KostyanB/3divi-test-task","id":"17","imgSrc":"img/diagram.webp","name":"Diagram","stack":"React JS, Redux/Toolkit, Styled Components, RestAPI"},{"demoUrl":"https://mrmagamba.web.app/","description":"Pet-проект. Приложение для онлайн заказа из ресторана-бургерной. Регистрация через Google Auth, формирование корзины, отправка на сервер и подтверждение пользователю на e-mail.","gitUrl":"https://github.com/KostyanB/MrMagamba","id":"6","imgSrc":"img/mrmagamba.webp","name":"MrMagamba","stack":"React JS, Styled Components, Firebase, Google Auth, Nodemailer"},{"demoUrl":"https://planctonics-chat.web.app/","description":"Прототип внутреннего чата компании с 2 разделами. Авторизация (используйте Вася или Маруся). Демо хранение в LocalStorage. Редактирование и удаление своих постов. Режим админа.","gitUrl":"https://github.com/KostyanB/PlanctonicsChat","id":"7","imgSrc":"img/chat.webp","name":"Planctonics-chat","stack":"React JS, Styled Components, async API, auth"},{"demoUrl":"https://fitnessbody-1bf35.web.app","description":"Сайт фитнесс-клуба \\"Тело\\". Слайдеры, модальные окна, калькулятор, валидация данных, отправка данных на сервер и уведомление пользователя.","gitUrl":"https://github.com/KostyanB/FitnessBody","id":"8","imgSrc":"img/fitness.webp","name":"Fitness-body","stack":"Native JS, RestAPI"},{"demoUrl":"https://mygame-blast.web.app/","description":"Игра по мотивам популярных blast-games. В демо цель - набрать 100 очков за 25 ходов.  Расширенные настройки приложения в JSON файле. Пользователь настраивает размеры поля и количество цветов. Минимальное сжигание - 3 тайтла.","gitUrl":"https://github.com/KostyanB/gameBlast","id":"9","imgSrc":"img/gameblast.webp","name":"Game-blast","stack":"Native JS, HTML5, CSS3"},{"demoUrl":"https://venom2-promo.web.app/","description":"Промо-страница премьеры фильма Venom-2. Обратный отсчет времени до премьеры. Модальный агент - отправка заявки на билеты. Просмотр трейлера.","gitUrl":"https://github.com/KostyanB/venom2","id":"10","imgSrc":"img/venom.webp","name":"Venom-2","stack":"Native JS, HTML5, CSS3"},{"demoUrl":"https://testcalc-f96a3.web.app/","description":"Калькулятор. Ввод алгебраического выражения с экрана или клавиатуры. Операции +-*/ и скобки. 12 разрядов. Валидация ввода: не число, скобки, деление на 0. С клавиатуры `Backspase` и `Delete` удаление, `Esc` сброс, `Enter` расчет.","gitUrl":"https://github.com/KostyanB/Calculator","id":"11","imgSrc":"img/calc.webp","name":"Calculator","stack":"Native JS, HTML5, CSS3 / SCSS"},{"demoUrl":"https://fibonnum.web.app/","description":"Приложение позволяет \\"легко\\" вычислять число Фибоначчи для практически любых исходных данных и ограничено только вычислительной мощностью компьютера, возможностями браузера и здравым смыслом.","gitUrl":"https://github.com/KostyanB/getFibon","id":"18","imgSrc":"img/fibon.webp","name":"Fibonacci","stack":"React JS, Hooks, Context, Styled Components, SASS"},{"demoUrl":"https://kostyanb.github.io/personalBudget","description":"Калькулятор личного бюджета. Расчет бюджета и срока накопления желаемой суммы на основании данных пользователя  о доходах, расходах, и банковском депозите.","gitUrl":"https://github.com/KostyanB/personalBudget","id":"12","imgSrc":"img/personal.webp","name":"Personal Budget","stack":"Native JS, ООП, HTML5, CSS3"},{"demoUrl":"https://dglo-17cec.web.app/","description":"3D-glo классический сайт дизайн студии. Таймер обратного отсчета, слайдеры, калькулятор стоимости, маски и валидация ввода данных, взаимодействие с сервером.","gitUrl":"https://github.com/KostyanB/3Dglo","id":"13","imgSrc":"img/3dglo.webp","name":"3D-glo","stack":"Native JS, Fetch API, HTML5, CSS3"},{"demoUrl":"https://todospa-b7372.web.app","description":"Ну и куда же без ToDo-шки. Добавление, удаление, редактирование и перемещение между листами. В демо синхронизация с fake сервером. Прелоадер и обработка ошибок сервера с оповещением пользователя.","gitUrl":"https://kostyanb.github.io/ToDo-SPA/","id":"14","imgSrc":"img/todo.webp","name":"ToDo","stack":"React JS, Redux/Toolkit, Styled Components, RestAPI"},{"demoUrl":"https://kostyanb.github.io/chessHorse/","description":"\\"Лошадью ходи...\\". Расчет и подсветка возможных ходов шахматного \\"коня\\". Перемещение через отслеживание позиции указателя.","gitUrl":"https://github.com/KostyanB/chessHorse","id":"15","imgSrc":"img/chess.webp","name":"Chess Horse","stack":"Native JS, HTML5, CSS3, drag&drop"},{"demoUrl":"https://wildpotatos-53c4a.web.app/","description":"Версия сайта известного интернет-магазина Wildbe**ies. Загрузка товаров с сервера. Динамическое фильтрация карточек товаров. Управление корзиной. Отправка заказа на сервер. Валидация данных пользователя при отправке заказа.","gitUrl":"https://github.com/KostyanB/WildPotatos","id":"16","imgSrc":"img/wild.webp","name":"Wildpotatos","stack":"Native JS, Fetch API, HTML5, CSS3, adaptive"}]');
...
/* harmony default export */ var modules_drawWorks = (drawWorks);
;// CONCATENATED MODULE: ./src/modules/arrowTop.js
